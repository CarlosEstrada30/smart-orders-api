...
class TestClientSimple:
    ...
    def test_create_client_endpoint(self, authenticated_client, db_session, sample_client_data):
    ...
    def test_get_clients_endpoint(self, authenticated_client, setup_factories):
        ...
        client = ClientFactory.create(name="Test Company", email="test@example.com")
    ...
    def test_create_client_without_authentication(self, client, sample_client_data):
    ...
    def test_create_client_with_minimal_data(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/clients/", json=minimal_data)
