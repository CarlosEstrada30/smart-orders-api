...
class TestProductEndpoints:
    ...
    def test_create_product_endpoint(self, authenticated_client, db_session, sample_product_data):
    ...
    def test_update_product_endpoint(self, authenticated_client, setup_factories, db_session):
    ...
    def test_delete_product_endpoint(self, authenticated_client, setup_factories, db_session):
    ...
    def test_create_product_with_minimal_data(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/products/", json=minimal_data)
    ...
    def test_create_product_without_authentication(self, client, sample_product_data):
