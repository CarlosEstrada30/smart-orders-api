    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if me_response.status_code == 200:
                ...
                print(
                    f"✅ Información del usuario obtenida: {user_info['email']}")
            else:
                print(
                    f"❌ Error al obtener información del usuario: {me_response.status_code}")
            ...
            if users_response.status_code == 200:
                ...
                print(
                    f"❌ Error al obtener usuarios: {users_response.status_code}")
            ...
            if no_token_response.status_code == 401:
                ...
                print(
                    f"❌ Debería haber rechazado acceso sin token: {no_token_response.status_code}")
            ...
            if invalid_response.status_code == 401:
                ...
                print(
                    f"❌ Debería haber rechazado token inválido: {invalid_response.status_code}")
