...
class SettingsRepository(BaseRepository[Settings, SettingsCreate, SettingsUpdate]):
    def __init__(self):
    ...
    def update_logo_url(self, db: Session, *, settings_id: int, logo_url: str) -> Optional[Settings]:
        """
