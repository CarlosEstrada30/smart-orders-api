...
from ..dependencies import get_order_service, get_settings_service, get_whatsapp_service
...
def send_order_receipt_whatsapp(
    ...
    message: Optional[str] = Query(
        None,
        description="Mensaje personalizado para acompañar el comprobante. Si no se proporciona, se usará un mensaje por defecto."
    ),
    db: Session = Depends(get_tenant_db),
    order_service: OrderService = Depends(get_order_service),
    settings_service: SettingsService = Depends(get_settings_service),
